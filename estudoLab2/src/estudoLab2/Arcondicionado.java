...
public class Arcondicionado {
	...
	public void aumentaTemperatura(double tempMais) {
		...
		if(temperaturaAtual < 16 || temperaturaAtual >32)
			...
			this.temperaturaAtual -= tempMais;
			System.out.println("Erro: temperatura invalida, temperatura mantida em:" +this.temperaturaAtual);
		}
	}
	...
	public void diminuiTemperatura_2(double tempMenos) throws IllegalArgumentException {
		this.temperaturaAtual -= tempMenos;
		if(temperaturaAtual < 16 || temperaturaAtual >32)
			this.temperaturaAtual += tempMenos;
			throw new IllegalArgumentException();
